      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter pt-space-lg">
        ...
        <div className="bg-surface-container-low rounded-3xl p-space-md flex flex-col justify-between border border-surface-container-highest hover:border-outline-variant transition-colors group">
          ...
          <div className="pt-space-md space-y-space-xs">
            ...
            <Link href="https://wa.me/6281236305053?text=Halo%20KING SPORT%2C%20saya%20tertarik%20pesan%20Redline%20Titan" className="w-full mt-2 inline-flex items-center justify-center gap-1.5 py-2 rounded-xl bg-surface-container-high hover:bg-on-surface hover:text-surface text-on-surface font-label-caps text-label-caps uppercase tracking-wider transition-all">
        ...
        <div className="bg-surface-container-low rounded-3xl p-space-md flex flex-col justify-between border border-surface-container-highest hover:border-outline-variant transition-colors group">
          ...
          <div className="pt-space-md space-y-space-xs">
            ...
            <Link href="https://wa.me/6281236305053?text=Halo%20KING SPORT%2C%20saya%20tertarik%20pesan%20Neon%20Volt%2007" className="w-full mt-2 inline-flex items-center justify-center gap-1.5 py-2 rounded-xl bg-surface-container-high hover:bg-on-surface hover:text-surface text-on-surface font-label-caps text-label-caps uppercase tracking-wider transition-all">
              <span>PESAN VIA WHATSAPP</span>
              <ArrowUpRight className="w-4 h-4" />
            </Link>
          </div>
        ...
        <div className="bg-surface-container-low rounded-3xl p-space-md flex flex-col justify-between border border-surface-container-highest hover:border-outline-variant transition-colors group">
          ...
          <div className="pt-space-md space-y-space-xs">
            ...
            <Link href="https://wa.me/6281236305053?text=Halo%20KING SPORT%2C%20saya%20tertarik%20pesan%20Stealth%20Raven" className="w-full mt-2 inline-flex items-center justify-center gap-1.5 py-2 rounded-xl bg-surface-container-high hover:bg-on-surface hover:text-surface text-on-surface font-label-caps text-label-caps uppercase tracking-wider transition-all">
              <span>PESAN VIA WHATSAPP</span>
              <ArrowUpRight className="w-4 h-4" />
            </Link>
          </div>
